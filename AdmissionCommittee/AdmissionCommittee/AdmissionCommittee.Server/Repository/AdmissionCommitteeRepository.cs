...
public class AdmissionCommitteeRepository : IAdmissionCommitteeRepository
{
    ...
    /// </summary>
    private List<StatementSpecialty> _statementSpecialtiesWithSpecialty;
    ...
    /// </summary>
    private List<EntrantResult> _entrantResultsWithResult;

    /// <summary>
    /// List of Entrant with Statement and empty EntrantResult
    /// </summary>
    private List<Entrant> _entrantsWithStatement;

    /// <summary>
    ///  List of Entrant with EntrantResult
    /// </summary>
    private List<Entrant> _entrantsWithEntrantResult;

    public AdmissionCommitteeRepository()
    {
        CreateSpecialties();

        CreateStatementSpecialtiesWithSpecialty();

        CreateStatements();

        CreateResults();

        CreateEntrantResultsWithResult();

        CreateEntrantsWithStatement();

        CreateEntrantsWithEntrantResult();
    }
    ...
    private void CreateStatementSpecialtiesWithSpecialty()
    {
        var specialtyList = _specialties;
        ...
        _statementSpecialtiesWithSpecialty = statementSpecialtyList;
    }

    private void CreateStatements()
    {
        var statementSpecialtyList = _statementSpecialtiesWithSpecialty;
    ...
    private void CreateEntrantResultsWithResult()
    {
        var resultList = _results;
        ...
        _entrantResultsWithResult = entrantResultList;
    }

    private void CreateEntrantsWithStatement()
    {
        var statementList = _statements;
        ...
        _entrantsWithStatement = entrantList;
    }

    private void CreateEntrantsWithEntrantResult()
    {
        var entrantResultList = _entrantResultsWithResult;
        var entrantList = _entrantsWithStatement;
        ...
        _entrantsWithEntrantResult = entrantList;
    }

    /// <summary>
    /// Get List of Specialty with empty StatementSpecialties
    /// </summary>
    public List<Specialty> Specialties => _specialties;

    /// <summary>
    /// Get List of StatementSpecialty with Speciality and empty Statement
    /// </summary>
    public List<StatementSpecialty> StatementSpecialtiesWithSpecialty => _statementSpecialtiesWithSpecialty;

    /// <summary>
    /// Get List of Statement with StatementSpecialty and empty Entrant
    /// </summary>
    public List<Statement> Statements => _statements;

    /// <summary>
    /// Get List of Result with empty EntrantResult
    /// </summary>
    public List<Result> Results => _results;

    /// <summary>
    /// Get List of EntrantResult with Result and empty Entrant
    /// </summary>
    public List<EntrantResult> EntrantResultsWithResult => _entrantResultsWithResult;

    /// <summary>
    /// Get List of Entrant with Statement and empty EntrantResult
    /// </summary>
    public List<Entrant> EntrantsWithStatement => _entrantsWithStatement;

    /// <summary>
    /// List of Entrant with EntrantResult
    /// </summary>
    public List<Entrant> EntrantsWithEntrantResult => _entrantsWithEntrantResult;
}