...
public class BicycleFixture
{
    ...
    public List<BicycleRental> FixRentals
    {
        get => new()
            {
            new BicycleRental() {SerialNumber = 1,CustomerId = 1,RentalTime = 1 },
            new BicycleRental() {SerialNumber = 3,CustomerId = 2, RentalTime = 2 },
            new BicycleRental() {SerialNumber = 4,CustomerId = 3,RentalTime = 1 },
            new BicycleRental() {SerialNumber = 5,CustomerId = 4,RentalTime = 3 },
            new BicycleRental() {SerialNumber = 1,CustomerId = 5, RentalTime = 1 },
            new BicycleRental() {SerialNumber = 4,CustomerId = 4,RentalTime = 2 },
            new BicycleRental() {SerialNumber = 9,CustomerId = 3, RentalTime = 3  },
            new BicycleRental() {SerialNumber = 10,CustomerId = 4, RentalTime = 1},
            new BicycleRental() {SerialNumber = 6,CustomerId = 2, RentalTime = 2},
            new BicycleRental() {SerialNumber = 5,CustomerId = 1, RentalTime = 3}            
            };
    }
}
