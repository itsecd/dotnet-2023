...
{
    static public void AddMany<T>(this List<T> list, params T[] additions)
    {
...
public class CompanyDomainFixture
{
    ...
    public CompanyDomainFixture()
    {
        ...
        _workshops[0].Workers.AddMany(_workers[0], _workers[1]);
        _workshops[1].Workers.AddMany(_workers[2], _workers[3]);
        _workshops[2].Workers.AddMany(_workers[4], _workers[5]);
        _workshops[3].Workers.AddMany(_workers[6], _workers[7]);

        _departments[0].DepartmentWorkers.AddMany(_workersAndDepartments[0], _workersAndDepartments[4], _workersAndDepartments[8]);
        _departments[1].DepartmentWorkers.AddMany(_workersAndDepartments[1], _workersAndDepartments[5], _workersAndDepartments[9]);
        _departments[2].DepartmentWorkers.AddMany(_workersAndDepartments[2], _workersAndDepartments[6], _workersAndDepartments[10]);
        _departments[3].DepartmentWorkers.AddMany(_workersAndDepartments[3], _workersAndDepartments[7], _workersAndDepartments[11], _workersAndDepartments[12], _workersAndDepartments[13]);

        _jobs[0].JobWorkers.AddMany(_workersAndJobs[0], _workersAndJobs[1], _workersAndJobs[2], _workersAndJobs[3]);
        _jobs[1].JobWorkers.AddMany(_workersAndJobs[4], _workersAndJobs[5]);
        _jobs[2].JobWorkers.AddMany(_workersAndJobs[6], _workersAndJobs[7]);
        ...
        _workers[0].WorkerDepartments.AddMany(_workersAndDepartments[0], _workersAndDepartments[1]);
        _workers[1].WorkerDepartments.AddMany(_workersAndDepartments[2], _workersAndDepartments[3]);
        _workers[2].WorkerDepartments.AddMany(_workersAndDepartments[0], _workersAndDepartments[1]);
        _workers[3].WorkerDepartments.AddMany(_workersAndDepartments[2], _workersAndDepartments[3]);
        _workers[4].WorkerDepartments.AddMany(_workersAndDepartments[0], _workersAndDepartments[1], _workersAndDepartments[2]);
