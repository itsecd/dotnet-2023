...
public class DepartmentDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        var course1 = new Course { Id = 1, SubjectName = "Math", SubjectId = 1, CourseType = "Lectures", SemesterHours = 256, GroupId = 6312, TeachersName = "Maksimova Lyudmila", TeacherId = 1 };
        var course2 = new Course { Id = 2, SubjectName = "Industrial programming", SubjectId = 2, CourseType = "Course project", SemesterHours = 123, GroupId = 6311, TeachersName = "Shashkova Tatiana", TeacherId = 2 };
        var course3 = new Course { Id = 3, SubjectName = "Physics", CourseType = "Course project", SubjectId = 5, SemesterHours = 14, GroupId = 6295, TeachersName = "Maksimova Lyudmila", TeacherId = 1 };
        var course4 = new Course { Id = 4, SubjectName = "Math", SubjectId = 1, CourseType = "Lectures", SemesterHours = 500, GroupId = 6311, TeachersName = "Shashkova Tatiana", TeacherId = 2 };
