...
public class BicycleTests
{
    ...
    {
        // Act
        var sportBikes = fixture.FixBicycles.Where((Func<Bicycle, bool>)(b => b.Type.TypeName == "Sport"));
        // Assert
    ...
    {
        // Arrange        
        var mountainBikes = fixture.FixBicycles.Where((Func<Bicycle, bool>)(b => b.Type.TypeName == "Mountain"));
        // Act
        var customerNames = from c in fixture.FixCustomers
                            join r in fixture.FixRentals on c.Id equals r.Customer.Id
    ...
    {
        // Act
        var totalRentalTime = fixture.FixRentals.GroupBy(r => r.Bicycle.Type.TypeName)
    ...
    {
        // Act
        var customerRentalCounts = fixture.FixRentals.GroupBy(br => br.Customer.Id)
                                             .Select(g => new { CustomerId = g.Key, RentalCount = g.Count() })
                                             .OrderByDescending(c => c.RentalCount);
        var mostRentedCustomers = from c in fixture.FixCustomers
    ...
    public void TestTop5MostRentedBikes()
    {
        ...
        var top5Bikes = fixture.FixRentals
    ...
    public void TestMinMaxAvgRentalTime()
    {
        ...
        var rentalTimes = fixture.FixRentals
