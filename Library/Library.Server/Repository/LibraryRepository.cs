...
public class LibraryRepository : ILibraryRepository
{
    ...
    public LibraryRepository()
    {
        ...
        {
            new Reader { Id = 0, FullName = "Chernyi Vladislav Andreevich", Address = "Moscow highway 34", Phone = "89277668974", RegistrationDate = new DateOnly(2022, 12, 25)},
            new Reader { Id = 1, FullName = "Kurakin Artem Sergeevich", Address = "Moscow highway 34", Phone = "89277668974", RegistrationDate = new DateOnly(2022, 12, 25)},
            new Reader { Id = 2, FullName = "Arapenkov Stepan Vladimirovich", Address = "Moscow highway 34", Phone = "89277352678", RegistrationDate = new DateOnly(2022, 12, 25)},
            new Reader { Id = 3, FullName = "Danilov Artem Andreevich", Address = "Moscow highway 34", Phone = "89277114578", RegistrationDate = new DateOnly(2022, 12, 26)},
            new Reader { Id = 4, FullName = "Denisov Stepan Vladimirovich", Address = "Moscow highway 34", Phone = "89277550173", RegistrationDate = new DateOnly(2022, 12, 27)}
        };

        _cards = new List<Card>
        {
            new Card { Id = 0, DateOfIssue = new DateOnly(2022, 12, 29), DateOfReturn = new DateOnly(2023, 1, 28), DayCount = 31, ReaderId = 0, Reader = new List<Reader> { _readers[0] }, BooksId = 0, Books = new List<Book> { _books[0] } },
            new Card { Id = 1, DateOfIssue = new DateOnly(2022, 12, 29), DateOfReturn = new DateOnly(2023, 1, 28), DayCount = 31, ReaderId = 0, Reader = new List<Reader> { _readers[0] }, BooksId = 3, Books = new List<Book> { _books[3] } },
            new Card { Id = 2, DateOfIssue = new DateOnly(2022, 12, 29), DateOfReturn = new DateOnly(2023, 1, 28), DayCount = 31, ReaderId = 1, Reader = new List<Reader> { _readers[1] }, BooksId = 3, Books = new List<Book> { _books[3] } },
            new Card { Id = 3, DateOfIssue = new DateOnly(2022, 12, 29), DateOfReturn = new DateOnly(2023, 1, 28), DayCount = 31, ReaderId = 1, Reader = new List<Reader> { _readers[1] }, BooksId = 1, Books = new List<Book> { _books[1] } },
            new Card { Id = 4, DateOfIssue = new DateOnly(2022, 12, 29), DateOfReturn = new DateOnly(2023, 1, 31), DayCount = 31, ReaderId = 1, Reader = new List<Reader> { _readers[1] }, BooksId = 2, Books = new List<Book> { _books[2] } },
            new Card { Id = 5, DateOfIssue = new DateOnly(2022, 12, 30), DateOfReturn = new DateOnly(2023, 2, 14), DayCount = 30, ReaderId = 2, Reader = new List<Reader> { _readers[2] }, BooksId = 2, Books = new List<Book> { _books[2] } },
            new Card { Id = 6, DateOfIssue = new DateOnly(2022, 12, 30), DateOfReturn = new DateOnly(2023, 2, 14), DayCount = 30, ReaderId = 3, Reader = new List<Reader> { _readers[3] }, BooksId = 1, Books = new List<Book> { _books[1] } },
            new Card { Id = 7, DateOfIssue = new DateOnly(2023, 2, 14), DateOfReturn = new DateOnly(2023, 2, 28), DayCount = 21, ReaderId = 4, Reader = new List<Reader> { _readers[4] }, BooksId = 0, Books = new List<Book> { _books[0] } }
        };
    }
