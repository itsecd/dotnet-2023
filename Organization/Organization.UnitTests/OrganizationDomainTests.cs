...
public class OrganizationDomainTestClass : IClassFixture<OrganizationDomainFixture>
{
    private readonly OrganizationDomainFixture _fixture;
    public OrganizationDomainTestClass(OrganizationDomainFixture fixture)
    {
        _fixture = fixture;
    }
    /// <summary>
