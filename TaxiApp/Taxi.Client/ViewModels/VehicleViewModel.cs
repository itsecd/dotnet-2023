...
public class VehicleViewModel : ViewModelBase
{
    ...
    [Required] [Reactive] public string RegistrationCarPlate { get; set; } = string.Empty;

    [Required] [Reactive] public string Colour { get; set; } = string.Empty;

    [Required] [Reactive] public ulong VehicleClassificationId { get; set; }

    [Required] [Reactive] public ulong DriverId { get; set; }
