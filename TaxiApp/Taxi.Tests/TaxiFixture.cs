...
/// <summary>
///     TaxiFixture - class that generates the test data
/// </summary>
public class TaxiFixture
{
    /// <summary>
    ///     FixtureVehicleClassifications return list of element of the VehicleClassification
    /// </summary>
    ...
    /// <summary>
    ///     FixtureDrivers return list of element of the Driver
    /// </summary>
    ...
    /// <summary>
    ///     FixtureVehicles return list of element of the Vehicle
    /// </summary>
    ...
    /// <summary>
    ///     FixturePassengers return list of element of the Passenger
    /// </summary>
    public List<Passenger> FixturePassengers
    {
        get
        {
            ...
            {
                firstPassenger, secondPassenger, thirdPassenger, fourthPassenger, fifthPassenger, sixthPassenger,
                seventhPassenger
            };
        }
    }
    ...
    /// <summary>
    ///     FixtureRides return list of element of the Ride
    /// </summary>
