...
public class FixtureRealt
{
...

    {
        ...
        _applications = new List<Application>
            {
                firstApplication, secondApplication, thirdApplication, fourthApplication, fifthApplication, sixthApplication , seventhApplication
            };
    ...
    public List<ApplicationHasHouse> ApplicationHasHouses => _applicationHasHouse;
}