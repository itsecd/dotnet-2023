...
public class UnitTest : IClassFixture<FixtureRealt>
{
    ...
    public void AllClients()
    {
        ...
        Assert.Equal("Shnirov", resultList[0].Surname);
        Assert.Equal("Sergey", resultList[0].Name);
        Assert.Equal("Krasnoarmeyskaya, 1a", resultList[0].Registration);
        Assert.Equal("336-64-36", resultList[0].Number);
        Assert.Equal("32218", resultList[0].Passport);
        ...
        Assert.Equal("Gorshnev", resultList[2].Surname);
        Assert.Equal("Michael", resultList[2].Name);
        Assert.Equal("Aerodromnaya, 47a", resultList[2].Registration);
        Assert.Equal("880-05-55", resultList[2].Number);
        Assert.Equal("91245", resultList[2].Passport);
    }
    /// <summary>
    ...
    public void TopFive()
    {
        ...
        Assert.Equal("Shnirov", result[0].Surname);
        Assert.Equal("Gorshnev", result[3].Surname);
        ...
        Assert.Equal(0, result2[0].Count);
