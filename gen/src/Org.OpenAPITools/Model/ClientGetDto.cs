...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ClientGetDto :  IEquatable<ClientGetDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClientGetDto" /> class.
        /// </summary>
        ...
        public ClientGetDto(long id = default(long), string lastName = default(string), string firstName = default(string), string patronymic = default(string), DateTime birthDate = default(DateTime), string passport = default(string))
        {
        ...
        {
            return this.Equals(input as ClientGetDto);
        }

        /// <summary>
        /// Returns true if ClientGetDto instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientGetDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientGetDto input)
        {
            if (input == null)
                return false;
