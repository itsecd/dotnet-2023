...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class IssuedCar :  IEquatable<IssuedCar>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IssuedCar" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="vehicleId">vehicleId.</param>
        /// <param name="clientId">clientId.</param>
        /// <param name="rentalInformationId">rentalInformationId.</param>
        /// <param name="refundInformationId">refundInformationId.</param>
        public IssuedCar(long id = default(long), long vehicleId = default(long), long clientId = default(long), long rentalInformationId = default(long), long? refundInformationId = default(long?))
        {
        ...
        {
            return this.Equals(input as IssuedCar);
        }

        /// <summary>
        /// Returns true if IssuedCar instances are equal
        /// </summary>
        /// <param name="input">Instance of IssuedCar to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IssuedCar input)
        {
            if (input == null)
                return false;
