...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class VehicleGetDto :  IEquatable<VehicleGetDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VehicleGetDto" /> class.
        /// </summary>
        ...
        public VehicleGetDto(long id = default(long), string number = default(string), long vehicleModelId = default(long), string colour = default(string))
        {
            this.Number = number;
            this.Colour = colour;
            this.Id = id;
        ...
        {
            return this.Equals(input as VehicleGetDto);
        }

        /// <summary>
        /// Returns true if VehicleGetDto instances are equal
        /// </summary>
        /// <param name="input">Instance of VehicleGetDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VehicleGetDto input)
        {
            if (input == null)
                return false;
